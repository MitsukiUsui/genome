...
windowSize_bp=500
countFilepath=${outDir}count/${basename}_chromosome_simu${shuffleMode1}${shuffleMode2}_count.csv
transFilepath=${outDir}trans/${basename}_chromosome_simu${shuffleMode1}${shuffleMode2}_trans.csv
transdegFilepath=${outDir}transdeg/${basename}_chromosome_simu${shuffleMode1}${shuffleMode2}_transdeg.csv
